...
def pddl_solver(problem, domain):
    ...
    try:
        ...
        if result.returncode == 0:
            print("Success!")
            solution_file = f'../results/{problem_file}.soln'
...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLM.from_pretrained("google/gemma-2-2b-it", quantization_config=nf4_config,  device_map="auto")
